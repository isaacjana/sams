...
$v_param['usr_comm'] = ( !isset($_GET['usr_comm']) || $_GET['usr_comm'] == '' ) ? '' : $_GET['usr_comm'];
...
$v_param['toggle'] .= '&usr_comm='.urlencode($v_param['usr_comm']);
...
$v_param['paging'] .= '&usr_comm='.urlencode($v_param['usr_comm']);
...
$v_cond['usr_from'] = $v_param['usr_from'];
$v_cond['usr_comm'] = $v_param['usr_comm'];
