...
$v_user_acl_infor = \E::get( 'obj_curr_module')->user_acl_get($v_id);
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	if(!\I::is_error()){
		...
		if($_POST['usr_group'] != 'no_access'){
			...
			$v_user_acl_infor = \E::get('obj_curr_module')->user_acl_get( $_POST['id'] );
		...
		header('location: ' . \E::get('obj_curr_module')->build_action_path('user','view',$_POST['id']));
		exit();
	}
	foreach($_POST as $v_key => $v_value){
