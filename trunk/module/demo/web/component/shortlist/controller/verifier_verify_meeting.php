...
$v_short_info_two = \E::get( 'obj_curr_module')->shortlist_shru_verify_detail( $v_id );
$v_val['nom_id'] = $v_id;
...
$v_var = array(
				...
				'user_verify_detail' => $v_short_info_two,
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if($v_add['meet_stat'] == 'lulus'){
			$v_add['meeting_status'] = '19';				
	}else{
			$v_add['meeting_status'] = '20';
	}
	
	\E::get('obj_curr_module')->shortlist_verifier($v_add);			
	unset($v_add);
	...
	header('location: ' . \E::get('obj_curr_module')->build_action_path('shortlist','verifier_shortlist'));
	exit();
}
