<!-- <pre>
	<?php print_r($v_user_verify_detail) ?>
</pre> -->
<form class="w-100" id="frm_nom" name="frm_nom" method="post" onsubmit="return validate(this);" enctype="multipart/form-data">
	<p class="mb-12" style="padding-left: 20px; padding-top: 10px"><b>MEETING DECISION - VERIFIER</b></p>
	...
	<div class="col-11 row mt-4" style="margin-left: 10px; background-color: #fff">		
		<div class="col-6" style="margin-left: 10px;">
			<p class="mb-12" style="padding-top: 10px"><b>SHRU REMARKS</b></p>
		</div>
		<div class="col-6" style="margin-left: 10px;">
			<div class="form-group row" style="padding-left: 15px;">
				<label class="w-25 col-form-label" for="meet_stat">STATUS:</label>
				<?php if($v_user_detail['nom_status'] == '17'){ ?>
					<?php echo "LULUS"; ?>
				<?php }else{?>
			...
			<div class="form-group row" style="padding-left: 15px;">
				...
				<?php echo $v_user_verify_detail['tarikh_keputusan']; ?>
			</div>	
			<div class="form-group row" style="padding-left: 15px;">
				<label class="w-25 col-form-label" for="meetrem">REMARKS:</label>
				<textarea class="w-75 form-control compulsary" id="meetrem" name="meetrem" rows="5" readonly><?php echo $v_user_verify_detail['meeting_remarks']; ?></textarea>
			</div>											
		</div>
	</div>	
	<div class="col-11 row mt-4" style="margin-left: 10px; background-color: #fff">
		<div class="col-6" style="margin-left: 10px;">
			<p class="mb-12" style="padding-top: 10px"><b>VERIFIER REMARKS</b></p>
		</div>		
		<div class="col-6" style="margin-left: 10px;">
			<div class="form-group row" style="padding-left: 15px;">
				<label class="w-25 col-form-label" for="meet_stat">STATUS:</label>
				<div class="col-12 d-flex py-2">
					<div class="form-check col-6 row mx-3">
						<input class="form-check-input" type="checkbox" name="meet_stat" id="lulus" value="verified"> <!-- status = 17 -->
						<label class="form-check-label" for="lulus">VERIFIRED</label>
					</div>
					<!-- <div class="form-check col-6 row mx-0 px-0 mx-3">
						<input class="form-check-input" type="radio" name="meet_stat" id="tidak_lulus" value="tidak_lulus">
	...
	<div class="col-11 col-md-11" style="padding-top: 10px; padding-bottom: 30px">
	    <div class="form-group row">
	        ...
	        <div class="col-sm-10">
				<a href="<?php echo \E::get( 'obj_curr_module')->build_action_path('shortlist','verifier_shortlist');?>" class="btn btn-danger" role="button">
