...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	// }
		...
		// 	\E::get('obj_curr_module')->nomination_penilai_satu($v_add);			
		// 	unset($v_add);
		...
		// 	\E::get('obj_curr_module')->nomination_penilai_satu_edit($v_add);			
		// 	unset($v_add);
		...
		// header('location: ' . \E::get('obj_curr_module')->build_action_path('nomination','penilaisatu_nom'));
		// exit();
		$v_var["post_val"]=$_POST;
