<p class="mb-4" style="padding-left: 10px; padding-top: 10px"><b>BAHAGIAN I: ULASAN KETUA JABATAN<br></b><b>Nota Penting: Hendaklah diisi dan dilengkapkan oleh KETUA JABATAN kepada Calon sahaja</b></p>
<form class="w-100">
	<div class="col-12 row mt-4">
		<div class="col-12 col-md-6">
			<div class="col-12">			
				<div class="form-group row">
    				<textarea class="form-control" id="alamat_rumah" rows="6"></textarea>
				</div>			
			</div>
