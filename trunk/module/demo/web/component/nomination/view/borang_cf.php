...
<form class="w-100" id="frm_bhgn_f" name="frm_bhgn_f" method="post" onsubmit="return validate(this);" enctype="multipart/form-data">
	<div class="col-12 row mt-4 mb-4">
		<div class="col-12 col-md-6"> 
			...
			<table class="table table-striped" id="kegiatanLuarSemasa">
			  <thead>
			    <tr>
			  ...
			  <tbody>
			    ...
			    <tr id="row_<?php echo $v_count; ?>">
			      <td><input class="form-control" type="text" id="pertubuhan_<?php echo $v_count; ?>" name="pertubuhan_<?php echo $v_count; ?>"></td>
			...
			<table style="width:100%; float: right; border-top: solid 1px #dee2e6;">
		    	...
		    	<tr>
		    		<td><input type="button" id="add-btn" value="ADD" class="btn btn-green" onclick="add_row_kegiatan_luar_semasa()"/></td>
		    	</tr>
		    </table>
		</div>
	</div>
