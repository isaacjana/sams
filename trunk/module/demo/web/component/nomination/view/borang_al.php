	...
	<div class="col-12 row mt-4">
		...
		<div class="col-12 col-md-6">
			<div class="col-12">
				<div class="form-group row">
					...
					<div class="w-75" id="no_folio">
						...
						if (isset($v_nom_profile["nom_folio_no"])) {
							...
							echo "SA/A/2020/".$v_folio_no."/...";
							echo "<input class='w-75 form-control' type='hidden' id='nom_folio_no' name='nom_folio_no' value='SA/A/2020/".$v_folio_no."/...'>";
						}
						?>
				...
				<div class="form-group row">
					<label class="w-25 col-form-label" for="ic_baru"></label>
					<div class="w-75">
						<a class="btn btn-primary" onclick="get_Gems();"><i class="fa fa-fw fa-search"></i><?php echo \E::get('obj_kernel_lang')->get('BTN_SEARCH'); ?></a>
					</div>
				</div>				
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<input class="w-75 form-control" list="list_pingat" id="pingat" name="pingat" onchange="get_singkatan('SA/A/2020/<?php echo $v_folio_no ?>/')" value="<?php echo \U::safe_display_string(isset($v_awd_type['awd_award']) ? $v_awd_type['awd_award'] : "");?>" required>
					<?php
                        $v_opt = '';
                        $v_count = 1;
				...
				<div class="form-group row" id="singkatan_area">
					...
					<input class="w-75 form-control" type="text" id="singkatan" name="singkatan"  value="<?php echo \U::safe_display_string(isset($v_awd_type['awd_acronym']) ? $v_awd_type['awd_acronym'] : "");?>" readonly>
					<input class="w-75 form-control" type="hidden" id="awd_type_id" name="awd_type_id" value="<?php echo \U::safe_display_string(isset($v_awd_type['awd_type_id']) ? $v_awd_type['awd_type_id'] : "");?>">
				</div>
				<div class="form-group row">
