<!-- <p class="mb-4" style="padding-left: 10px; padding-top: 10px"><b>BAHAGIAN J: REKOMENDASI SETIAUSAHA PERSEKUTUAN NEGERI SARAWAK (SUPS)<br></b></p>
<form class="w-100">
	<div class="col-12 row mt-4">
		<div class="col-12 col-md-6">
			<div class="col-12">
				...
				<div class="form-group row">
					<label class="w-25 col-form-label" for="alamat_rumah">Rekomendasi / Komen:</label>
    				<textarea class="w-75 form-control" id="alamat_rumah" rows="5"></textarea>
				</div>
