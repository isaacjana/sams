<p class="mb-4" style="padding-left: 10px; padding-top: 10px"><b>BAHAGIAN E: MAKLUMAT PENCALONAN YANG PERNAH DICALONKAN TETAPI TIDAK BERJAYA<br></b>(Nyatakan Darjah Kebesaran / Bintang / Pingat yang pernah dicalonkan tetapi <b>tidak berjaya </b>)</p>
<form class="w-100"  id="frm_bhgn_e" name="frm_bhgn_e" method="post" onsubmit="return validate(this);" enctype="multipart/form-data">
	<div class="col-12 row mt-4 mb-4">
		<div class="col-12 col-md-6"> 
		    ...
		    <div class="form-group row">
				<input class="w-75 form-control" type="hidden" id="bahagian_borang" name="bahagian_borang" value="e">
			</div>	
	        <div class="form-group row" style="padding-bottom: 15px; padding-left: 55px;">
	            <div class="col-sm-2"></div>
	            <div class="col-sm-10 text-right">
	                <a href="javascript:if(validate(document.frm_bhgn_e)) document.frm_bhgn_e.submit();" class="btn btn-primary" role="button">
