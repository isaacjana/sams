...
<form class="w-100"  id="frm_bhgn_k" name="frm_bhgn_k" method="post" onsubmit="return validate(this);" enctype="multipart/form-data">
...
<div class="col-12">
	...
	<div class="form-group row">
				<input class="w-75 form-control" type="hidden" id="bahagian_borang" name="bahagian_borang" value="k">
			</div>
	<div  class="col-12">
        <div class="form-group row" style="padding-bottom: 15px">
            <div class="col-sm-2"></div>
            <div class="col-sm-10 text-right">
                <a href="javascript:if(validate(document.frm_bhgn_k)) document.frm_bhgn_k.submit();" class="btn btn-primary" role="button">
