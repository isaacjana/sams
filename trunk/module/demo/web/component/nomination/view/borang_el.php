		...
		<div class="col-12 col-md-6">
			<div class="col-12">
				<div class="form-group row">
					...
					<div class="w-75" id="no_folio">
						...
						if (isset($v_nom_profile["nom_folio_no"])) {
							...
							echo "SA/E/2020/".$v_folio_no."/...";
							echo "<input class='w-75 form-control' type='hidden' id='nom_folio_no' name='nom_folio_no' value='SA/E/2020/".$v_folio_no."/...'>";
						}
						?>
				...
				<div class="form-group row">
					...
					<input class="w-75 form-control" list="list_pingat" id="pingat" name="pingat" onchange="get_singkatan('SA/E/2020/<?php echo $v_folio_no ?>/')" required>
					<?php
                        $v_opt = '';
                        $v_count = 1;
				...
				<div class="form-group row">
					...
					<input class="w-75 form-control" type="hidden" id="form_id" name="form_id" value="5">
