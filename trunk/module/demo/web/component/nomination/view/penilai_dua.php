<?php if($v_user_detail['nom_stat'] == '15' || $v_user_detail['nom_stat'] == '6'){ ?>
<form class="w-100" id="frm_nom" name="frm_nom" method="post" onsubmit="return validate(this);" enctype="multipart/form-data">
				...
				<table class="table">
					...
					<tbody>
						<tr>
							...
							<td><input class="w-75 form-control" type="text" id="syarat1" name="syarat1" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat1']) ? $v_user_detail_penilai_two['syarat1'] : "");?>"></td>
						</tr>					
						<tr>
							<td>2</td>
							...
							<td><input class="w-75 form-control" type="text" id="syarat2" name="syarat2" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat2']) ? $v_user_detail_penilai_two['syarat2'] : "");?>"></td>
						</tr>					
						<tr>
							<td>3</td>
							...
							<td><input class="w-75 form-control" type="text" id="syarat3" name="syarat3" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat3']) ? $v_user_detail_penilai_two['syarat3'] : "");?>"></td>
						</tr>					
						<tr>
							<td>4</td>
							...
							<td><input class="w-75 form-control" type="text" id="syarat4" name="syarat4" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat4']) ? $v_user_detail_penilai_two['syarat4'] : "");?>"></td>
						</tr>					
						<tr>
							<td>5</td>
							...
							<td><input class="w-75 form-control" type="text" id="syarat5" name="syarat5" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat5']) ? $v_user_detail_penilai_two['syarat5'] : "");?>"></td>
						</tr>
					</tbody>
				</table>
			</div>			
				...
				<table class="table">
					...
					<tbody>
						<tr>
							...
							<td><input class="w-75 form-control" type="text" id="syarat6" name="syarat6" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat6']) ? $v_user_detail_penilai_two['syarat6'] : "");?>"></td>
						</tr>					
						<tr>
							<td>2</td>
							...
							<td><input class="w-75 form-control" type="text" id="syarat7" name="syarat7" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat7']) ? $v_user_detail_penilai_two['syarat7'] : "");?>"></td>
						</tr>										
					</tbody>
				</table>
			</div>			
	...
	<div class="col-11 row mt-4" style="border: 1px solid #fff; background-color: #fff; margin-left: 10px; padding-bottom: 15px">
		...
		<div class="col-12" style="margin-left: 10px;">
				...
				<table class="table">
					...
					<tbody>
						<tr>
							...
							<td><input class="w-75 form-control" type="text" id="syarat8" name="syarat8" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat8']) ? $v_user_detail_penilai_two['syarat8'] : "");?>"></td>
						</tr>															
					</tbody>
				</table>			
			</div>	
			...
			<div class="form-group row" style="margin-left: 15px;">
				<textarea class="w-50 form-control" id="penilai_remarks" name="penilai_remarks"  rows="5" style=""><?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['penilai_remarks']) ? $v_user_detail_penilai_two['penilai_remarks'] : "");?></textarea>
			</div>						
		</div>	
	</div>	
	<div class="col-12 col-md-11" style="padding-top: 10px; padding-bottom: 30px">
	    <div class="form-group row">
	        ...
	        <div class="col-sm-10">
				<a href="<?php echo \E::get( 'obj_curr_module')->build_action_path('nomination','penilaidua_nom');?>" class="btn btn-danger" role="button">
