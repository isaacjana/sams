				...
				<table class="table">
					...
					<tbody>
						<tr>
							...
							<td><input class="w-75 form-control" type="text" id="syarat1" name="syarat1" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat1']) ? $v_user_detail_penilai_two['syarat1'] : "");?>" readonly></td>
						</tr>					
						<tr>
							<td>2</td>
							...
							<td><input class="w-75 form-control" type="text" id="syarat2" name="syarat2" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat2']) ? $v_user_detail_penilai_two['syarat2'] : "");?>" readonly></td>
						</tr>					
						<tr>
							<td>3</td>
							...
							<td><input class="w-75 form-control" type="text" id="syarat3" name="syarat3" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat3']) ? $v_user_detail_penilai_two['syarat3'] : "");?>" readonly></td>
						</tr>					
						<tr>
							<td>4</td>
							...
							<td><input class="w-75 form-control" type="text" id="syarat4" name="syarat4" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat4']) ? $v_user_detail_penilai_two['syarat4'] : "");?>" readonly></td>
						</tr>					
						<tr>
							<td>5</td>
							...
							<td><input class="w-75 form-control" type="text" id="syarat5" name="syarat5" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat5']) ? $v_user_detail_penilai_two['syarat5'] : "");?>" readonly></td>
						</tr>
					</tbody>
				</table>
			</div>			
				...
				<table class="table">
					...
					<tbody>
						<tr>
							...
							<td><input class="w-75 form-control" type="text" id="syarat6" name="syarat6" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat6']) ? $v_user_detail_penilai_two['syarat6'] : "");?>" readonly></td>
						</tr>					
						<tr>
							<td>2</td>
							...
							<td><input class="w-75 form-control" type="text" id="syarat7" name="syarat7" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat7']) ? $v_user_detail_penilai_two['syarat7'] : "");?>" readonly></td>
						</tr>										
					</tbody>
				</table>
			</div>			
	...
	<div class="col-11 row mt-4" style="border: 1px solid #fff; background-color: #fff; margin-left: 10px; padding-bottom: 15px">
		...
		<div class="col-12" style="margin-left: 10px;">
				...
				<table class="table">
					...
					<tbody>
						<tr>
							...
							<td><input class="w-75 form-control" type="text" id="syarat8" name="syarat8" value="<?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['syarat8']) ? $v_user_detail_penilai_two['syarat8'] : "");?>" readonly></td>
						</tr>															
					</tbody>
				</table>			
			</div>	
			...
			<div class="form-group row" style="margin-left: 15px;">
				<textarea class="w-50 form-control" id="penilai_remarks" name="penilai_remarks"  rows="5" style="" readonly><?php echo \U::safe_display_string(isset($v_user_detail_penilai_two['penilai_remarks']) ? $v_user_detail_penilai_two['penilai_remarks'] : "");?></textarea>
			</div>						
		</div>	
	</div>	
