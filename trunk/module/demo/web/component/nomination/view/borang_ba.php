		...
		<div class="col-12 col-md-6"> 
			<div class="col-12">
				<div class="form-group row">
					...
					<input class="w-75 form-control compulsary" type="text" id="nama_penuh" name="nama_penuh">
				</div>
				<div class="form-group row">
					...
					<input class="form-control compulsary" type="text" id="gelaran" name="gelaran">
				</div>
				<div class="form-group row">
					...
					<div class="col-12 d-flex py-2">
						<div class="col-6 row mx-0 px-0">
							...
							<input class="col-9 form-control" type="text" id="ic_lama" name="ic_lama">
						</div>
						<div class="col-6 row mx-0 px-0">
							<label class="col-3 col-form-label" for="ic_baru">Baru:</label>
							<input class="col-9 form-control" type="text" id="ic_baru" name="ic_baru">
						</div>
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<input class="w-75 form-control compulsary" type="date" id="tarikh_lahir" name="tarikh_lahir">
				</div>
				<div class="form-group row">
		...
		<div class="col-12 col-md-6">
			<div class="col-12">
				<div class="form-group row">
					...
					<input class="w-75 form-control compulsary" type="email" id="alamat_email" name="alamat_email">
				</div>
				<div class="form-group row">
					<label class="w-25 col-form-label" for="alamat_rumah">Alamat Rumah<small><b>(Yang Terkini)</b></small>:</label>
    				<input type="text" name="alamat_rumah1" id="alamat_rumah1" class="w-75 form-control">
    				<label class="w-25 col-form-label" for="alamat_rumah"></label>
    				<input type="text" name="alamat_rumah2" id="alamat_rumah2" class="w-75 form-control">
    				<label class="w-25 col-form-label" for="alamat_rumah"></label>
    				<input type="text" name="alamat_rumah3" id="alamat_rumah3" class="w-75 form-control">
    				<label class="w-25 col-form-label" for="alamat_rumah"></label>
    				<input type="text" name="alamat_rumah4" id="alamat_rumah4" class="w-75 form-control"> 
				</div>
				<div class="form-group row">
