<form class="w-100" id="frm_nom" name="frm_nom" method="post" onsubmit="return validate(this);" enctype="multipart/form-data">
	<p class="mb-12" style="padding-left: 20px; padding-top: 10px"><b>ROUTED BACK</b></p>
	<div class="col-11 row mt-4" style="margin-left: 10px">
		<div class="col-6" style="margin-left: 10px;">
			<div class="form-group row" style="padding-left: 15px;">
				...
				<textarea class="w-75 form-control compulsary" id="remarks" name="remarks" rows="5" required></textarea>
